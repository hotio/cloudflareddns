...
ARG IMAGE_STATS
ENV IMAGE_STATS=${IMAGE_STATS} INTERVAL=300 DETECTION_MODE="dig-whoami.cloudflare" LOG_LEVEL=3 UPDATE_IPV4="true" UPDATE_IPV6="false" APPRISE="" CF_USER="" CF_APIKEY="" CF_APITOKEN="" CF_HOSTS=""
